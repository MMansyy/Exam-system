    ...
    return (
        <div className="w-full md:w-72">
            ...
            <div className="mt-3">
                ...
                <div className="mt-4">
                    <Link to={`/quiz/${quiz.quizId}`} className='w-full hover:outline-1 hover:outline-black block text-center  bg-black text-white px-4 py-2 rounded-lg hover:bg-white hover:text-black border transition-all duration-300 cursor-pointer'>
                        Take Quiz
                    </Link>
                </div>
            </div>
